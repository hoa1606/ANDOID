...
public class DienThoaiAdapter extends BaseAdapter {
    ...
    private int layout;
    private List<com.example.th_ltdd.DienThoai> DienThoaiList;

    public DienThoaiAdapter(Context context, int layout, List<com.example.th_ltdd.DienThoai> dienThoaiList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {//trả về mỗi dòng trên tem
        ...
        com.example.th_ltdd.DienThoai dientThoai = DienThoaiList.get(i);
